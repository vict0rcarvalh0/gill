...
import { upgradeRoleToSigner } from "@solana/instructions";
...
export function getAccountMetaFactory(programAddress: Address, optionalAccountStrategy: "omitted" | "programId") {
  return (account: ResolvedAccount): AccountMeta | undefined => {
    if (!account.value) {
...
export function isTransactionSigner<TAddress extends string = string>(
  ...
  return !!value && typeof value === "object" && "address" in value && (typeof (value as any).signTransactions === 'function' || typeof (value as any).modifyAndSignTransactions === 'function');
}
